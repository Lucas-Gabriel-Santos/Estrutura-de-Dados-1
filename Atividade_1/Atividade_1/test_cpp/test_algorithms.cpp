...
int main() {
    ...
    RUN_TEST("Busca ordenada", busca_seq_ordenada(arr1, n1, 7 ), /* esperado */ 6);
    RUN_TEST("Busca ordenada", busca_seq_ordenada(arr1, n1, 14), 0);

    cout << "Função da contagem das especialidades distintas" << endl;
    RUN_TEST("Busca ordenada", conta_especialidades_distintas(arr1, 7), /* esperado */ 5);
    RUN_TEST("Busca ordenada", conta_especialidades_distintas(arr2, 7), /* esperado */ 7); 

    cout << "Teste da busca binária e BadVersion" << endl;
    RUN_TEST("Busca binaria", busca_binaria(5), 0);
    RUN_TEST("Busca binaria", busca_binaria(7), 0);
